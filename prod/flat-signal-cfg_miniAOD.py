...
## ---------- rho (doesn't work) #but should be already in the miniAOD
...
#- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
#---------- JEC using Factorized Jet corrector ---------------
# see in the plugin DijetTreeProducer.cc

# #---------- JEC using Jet corrector ---------------
# from JetMETCorrections.Configuration.JetCorrectionServices_cff import *

# process.ak8PFCHSL1Fastjet = ak4PFCHSL1Fastjet.clone(
#     algorithm = 'AK8PFchs'
#     ) 
# process.ak8PFCHSL2Relative = ak4PFCHSL2Relative.clone(
#     algorithm = 'AK8PFchs'
#     ) 
# process.ak8PFCHSL3Absolute = ak4PFCHSL3Absolute.clone(
#     algorithm = 'AK8PFchs'
#     ) 
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/cmshome/gdimperi/Dijet/CMSDIJETrepo/CMSSW_7_2_1_DiJet/src/CMSDIJET/DijetRootTreeMaker/prod/QstarToJJ_M_3000_PHYS14_MINIAODSIM.root')    
)
...
process.dijets     = cms.EDAnalyzer('DijetTreeProducer',
  ...
  rho_all = cms.InputTag("fixedGridRhoAll"),

  ## JETS/MET ########################################
  #JetCorrectionService_ak4 = cms.string('AK4PFchsL1FastL2L3'),
  #JetCorrectionService_ak8 = cms.string('AK8PFchsL1FastL2L3'),
...
process.p = cms.Path(
                     ...
                     #process.ak4PFCHSL1FastL2L3 *
                     #process.ak8PFCHSL1FastL2L3 
