...
#process.GlobalTag.globaltag = 'POSTLS170_Vslimmed5::All'
...
process.TFileService=cms.Service("TFileService",
                                 ...
                                 fileName=cms.string('mylocaltest_Run2016B_100000.root'),
...
# Causes fail. Try to disable. Juska.
...
# Data not running with these MC-variables in 80x. Juska
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring("file:/afs/cern.ch/user/j/juska/eos/cms/store/data/Run2015D/JetHT/MINIAOD/PromptReco-v4/000/260/431/00000/609D0321-DC83-E511-BE47-02163E01417D.root")
